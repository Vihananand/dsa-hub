          ...
          >
            <div className="flex items-center justify-center mb-4">
              <motion.div
                ...
                className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-white/10 to-white/5 glow-border mr-3"
              >
                <span className="text-2xl">⚡</span>
              </motion.div>
              <h3 className="text-2xl font-bold text-gradient">DSA Hub</h3>
            </div>
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center justify-center w-12 h-12 rounded-xl bg-white/10 hover:bg-white/20 text-gray-400 hover:text-white transition-all duration-300 glass glow-border"
                  >
                    {link.icon}
                  </motion.div>
